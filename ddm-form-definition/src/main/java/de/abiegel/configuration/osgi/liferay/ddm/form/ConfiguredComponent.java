...
@Component(configurationPid = {
		"de.abiegel.configuration.osgi.liferay.ddm.form.CompanyConfiguredComponentConfig" }, configurationPolicy = ConfigurationPolicy.OPTIONAL, property = {
...
public class ConfiguredComponent implements Fooable {
	...
	@Override
	public void foo() {
		logger.fatal("evil things can be done" );
	}
